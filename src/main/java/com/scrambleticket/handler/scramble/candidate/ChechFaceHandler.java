...
public class ChechFaceHandler implements FlowHandler {
    ...
    public void handle(FlowContext context, FlowHandlerChain chain) {
        ...
        candidateContext.removeFirstPlanTrainCode(); // 这边移除，用第一个提交，然后confirmHB时用剩下的做候补
        ...
        FullHttpRequest request = HttpUtils.createPostRequest("https://kyfw.12306.cn/otn/afterNate/chechFace", body);
    ...
    public enum seatTypeForHB {
        SWZ("9_商务座"), TZ("P_特等座"), ZY("M_一等座"), ZE("O_二等座"), GG("D_优选一等座"), GR("6_高级软卧"), RW("4_软卧"), SRRB("F_动卧"),
        YW("3_硬卧"), RZ("2_软座"), YZ("1_硬座"), WZ("1_无座"), QT("H_其他"),;
