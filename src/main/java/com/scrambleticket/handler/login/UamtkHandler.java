...
public class UamtkHandler implements FlowHandler {
    ...
    public void handle(FlowContext context, FlowHandlerChain chain) {
        ...
        request.headers().add(HttpHeaderNames.ORIGIN, "https://kyfw.12306.cn");
        request.headers().add(HttpHeaderNames.REFERER, "https://kyfw.12306.cn/otn/passport?redirect=/otn/login/userLogin");
        ...
        context.getClient().async(context.getConnectionId(), request, new Client.Callback() {
            ...
            public void onSuccess(FullHttpResponse response) {
                ...
                context.getAttributes().put(_embedded_cookie.Cookie.tk.getKey(), newapptk); // 供下面流程使用
